...
sub run {
    ...
    $self->render_file("static/js/jquery-1.11.3.min.js", "Akimacho/static/js/jquery-1.11.3.min.js");
    ...
    for my $env (qw(development production test)) {
        $self->render_file( "config/${env}.pl", "Akimacho/config/__ENV__.pl", { env => $env } );
    }
